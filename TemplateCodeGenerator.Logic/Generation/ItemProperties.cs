...
namespace TemplateCodeGenerator.Logic.Generation
{
    internal partial class ItemProperties
    {
        ...
        /// For example: 
        ///     FullName QTChinnok.Logic.Entities.Base.Artist becomes SubName Contracts.Base.Artist.
        /// </summary>
        ...
        /// This method creates the sub namespace from a solution entity type. 
        /// For example: 
        ///     FullName QTChinnok.Logic.Entities.Base.Artist becomes SubName Models.Base.Artist.
        /// </summary>
        /// <param name="type">The Type from which the subnamespace is created.</param>
        /// <returns>The subnamespace as a string.</returns>
        ...
        /// This method creates the sub namespace from a solution entity type. 
        /// For example: 
        ///     FullName QTChinnok.Logic.Entities.Base.Artist becomes SubName ServiceModels.Base.Artist.
        /// </summary>
        /// <param name="type">The Type from which the subnamespace is created.</param>
        /// <returns>The subnamespace as a string.</returns>
        ...
        /// For example: 
        ///     FullName QTChinnok.Logic.ServiceModel.Base.Artist becomes SubName ServiceModel.Base.Artist.
        /// </summary>
        ...
        /// For example: 
        ///     FullName QTChinnok.Logic.ServiceModel.Base.Artist becomes SubName ServiceModel.Base.
        /// </summary>
        /// <param name="type">The Type from which the SubNamespace is created.</param>
        /// <returns>The SubNamespace as a string.</returns>
